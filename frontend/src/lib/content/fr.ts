...
export const fr: Content = {
  ...
  watchlists: {
    ...
    createWatchlistDescription: 'Créez une nouvelle liste pour organiser vos films et séries.',
    notLoggedInWarning: 'Mode hors-ligne',
    ...
    categoriesDescription:
      'Sélectionnez une ou plusieurs catégories pour faciliter la découverte de votre liste',
    genreCategories: 'Catégories par genre',
    platformCategories: 'Plateformes de streaming',
    platformsDescription: 'Sélectionnez les plateformes sur lesquelles votre liste est disponible',
    name: 'Nom',
    namePlaceholder: 'Ma liste',
    description: 'Description',
    descriptionPlaceholder: 'Description de votre liste',
    ...
    noItemsDescription:
      'Commencez à ajouter des films et séries à votre liste pour organiser votre liste de visionnage.',
    edit: 'Modifier',
    editWatchlist: 'Modifier la liste',
    editWatchlistDescription: 'Modifiez les informations de votre liste.',
    ...
    startSearching: 'Recherchez des films et séries a ajouter à vos listes.',
    add: 'Ajouter',
    added: 'Ajouté',
    ...
    collaborators: {
      ...
      leaveDescription:
        'Êtes-vous sûr de vouloir quitter cette liste ? Vous perdrez vos droits de collaborateur.',
      leave: 'Quitter',
      leaving: 'Sortie...',
      leaveSuccess: 'Vous avez quitté la liste',
  ...
  home: {
    hero: {
      title: 'Vos listes parfaitement organisées',
    ...
    library: {
      title: 'Bibliothèque',
      subtitle: 'Vos listes personnelles',
      seeAll: 'Voir tout',
    },
    categories: {
  ...
  profile: {
    ...
    themeSection: {
      title: 'Thème',
      description: 'Choisissez le thème visuel de l\'interface',
      ocean: 'Océan',
      oceanDescription: 'Teintes bleues profondes',
      midnight: 'Minuit',
      midnightDescription: 'Gris neutre sombre',
    },
    toasts: {
