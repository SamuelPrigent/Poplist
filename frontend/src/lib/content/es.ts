...
export const es: Content = {
  ...
  watchlists: {
    ...
    noWatchlistsMobile: 'Ninguna lista',
    createWatchlistDescriptionMobile: 'Crea tu primera lista.',
    noWatchlists: 'Aún no has creado ninguna lista.',
    signupCta: {
      title: 'Crea una cuenta',
      description: 'Crea listas de películas y series y compártelas con la comunidad.',
      button: 'Regístrate',
    },
    ...
    recommendations: {
      title: 'Recomendados',
      similarTitle: 'Contenido similar',
      subtitle: 'Según el contenido de esta lista',
      refresh: 'Actualizar',
    },
    // Table headers
    tableHeaders: {
    ...
    toasts: {
      ...
      itemAdded: 'Añadido a la lista',
      itemRemoved: 'Eliminado de la lista',
      itemAddError: 'No se pudo añadir, inténtalo de nuevo',
      itemRemoveError: 'No se pudo eliminar, inténtalo de nuevo',
    },
  },

  landing: {
    hero: {
      title: 'Crea y comparte listas de tus contenidos favoritos',
      subtitle: 'Organiza tus noches de TV y comparte tus descubrimientos con tus amigos',
      titleMobile: 'Crea listas de tus contenidos favoritos',
      subtitleMobile: 'Organiza tus noches de TV',
    },
    features: {
      sectionTitle: 'Comparte tu universo cinematográfico',
      sectionTitleMobile: 'Nuestras funcionalidades',
    ...
    testimonials: {
      ...
      testimonial4: {
        text: 'Compartir con un enlace fue lo que me convenció. Mis amigos ven mi lista sin crear cuenta.',
        author: 'Karim B.',
        pseudo: '@karimb',
      },
      testimonial5: {
        text: 'Planeamos nuestras noches de series juntos, cada uno añade a la misma lista.',
        author: 'Léa P.',
        pseudo: '@leapasc',
      },
      testimonial6: {
        text: 'Por fin un lugar con todo lo que me recomiendan. Ya no busco durante 20 minutos.',
        author: 'Antoine R.',
        pseudo: '@antoiner',
      },
    },
  ...
  home: {
    ...
    faq: {
      ...
      subtitle: 'Las preguntas más frecuentes sobre la plataforma: el principio, nuestro valor añadido y su funcionamiento.',
      questions: {
        pricing: {
  ...
  categories: {
    ...
    list: {
      ...
      animation: {
        name: 'Animación',
        description: 'Las mejores series y películas de animación',
      },
      enfant: {
        name: 'Infantil',
      ...
      anime: {
        name: 'Anime',
        description: 'Anime japonés y manga adaptado',
      },
    },
  },
