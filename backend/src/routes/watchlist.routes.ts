...
router.post(
	"/:id/collaborators",
	requireAuth,
	watchlistController.addCollaborator
);
router.delete(
...
router.delete(
	"/:id/items/:tmdbId",
	requireAuth,
	watchlistController.removeItemFromWatchlist
);
router.put(
	"/:id/items/:tmdbId/position",
	requireAuth,
	watchlistController.moveItemPosition
);
...
router.post(
	...
	requireAuth,
	watchlistController.generateWatchlistThumbnail
);
...
router.post(
	"/:id/like-and-save",
	requireAuth,
	watchlistController.saveWatchlist
);
router.delete(
	"/:id/unlike-and-unsave",
	requireAuth,
	watchlistController.unsaveWatchlist
);
router.post(
	"/:id/duplicate",
	requireAuth,
	watchlistController.duplicateWatchlist
);
...
router.get(
	...
	cacheMiddleware(30),
	watchlistController.getItemDetails
);
