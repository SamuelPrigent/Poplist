...
export const signup = async (c: C, data: SignupInput) => {
  ...
  return c.json(
    ...
    } satisfies z.infer<typeof signupResponseSchema>,
    201,
  );
};
...
export const refresh = async (c: C) => {
  try {
    ...
    return c.json({ message: 'Tokens refreshed' } satisfies z.infer<typeof refreshResponseSchema>);
  } catch {
...
export const logout = async (c: C) => {
  ...
  clearAuthCookies(c);
  return c.json({ message: 'Logged out successfully' } satisfies z.infer<
...
export const setTokens = async (c: C, data: SetTokensInput) => {
  ...
  return c.json({ message: 'Tokens set successfully' } satisfies z.infer<
    typeof setTokensResponseSchema
  >);
};
...
export const checkUsernameAvailability = async (c: C) => {
  ...
  return c.json({ available: !existingUser, username } satisfies z.infer<
...
export const updateUsername = async (c: C, data: UpdateUsernameInput) => {
  ...
  } satisfies z.infer<typeof updateUsernameResponseSchema>);
};
...
export const changePassword = async (c: C, data: ChangePasswordInput) => {
  ...
  return c.json({ message: 'Password changed successfully' } satisfies z.infer<
...
export const updateLanguage = async (c: C, data: UpdateLanguageInput) => {
  ...
  } satisfies z.infer<typeof updateLanguageResponseSchema>);
};
...
export const deleteAccount = async (c: C, _data: DeleteAccountInput) => {
  ...
  return c.json({ message: 'Account deleted successfully' } satisfies z.infer<
