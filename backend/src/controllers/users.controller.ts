...
import { formatWatchlistWithRelations, loadWatchlistRelations } from './watchlists.controller.js';
...
export const getProfile = async (c: C) => {
  ...
  } satisfies z.infer<typeof getProfileResponseSchema>);
};
...
export const getUserProfileByUsername = async (c: C) => {
  ...
  } satisfies z.infer<typeof getUserProfileByUsernameResponseSchema>);
};
...
export const uploadAvatar = async (c: C, data: UploadAvatarInput) => {
  ...
  try {
    ...
    } satisfies z.infer<typeof uploadAvatarResponseSchema>);
  } catch (error) {
...
export const deleteAvatar = async (c: C) => {
  ...
  } satisfies z.infer<typeof deleteAvatarResponseSchema>);
};
